...
// collectCmd collects sentinel rewards
var collectCmd = &cobra.Command{
	Use:   "collect",
	Short: "Collect sentinel rewards",
	Long: `Collect accumulated sentinel rewards.

Sentinel rewards are earned by:
...
func init() {
	SentinelCmd.AddCommand(collectCmd)
}
...
func runCollect(cmdCobra *cobra.Command, args []string) error {
	...
	rewardInfo, err := rpcClient.SentinelApi.GetUncollectedReward(parsedAddress)
	if err != nil {
	...
	template := rpcClient.SentinelApi.CollectReward()
