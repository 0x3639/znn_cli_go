...
// collectCmd collects pillar rewards
var collectCmd = &cobra.Command{
	Use:   "collect",
	Short: "Collect pillar rewards",
	Long: `Collect accumulated pillar rewards.

Pillar rewards are earned by:
  - Producing momentums
...
func init() {
	PillarCmd.AddCommand(collectCmd)
}
...
func runCollect(cmdCobra *cobra.Command, args []string) error {
	...
	rewardInfo, err := rpcClient.PillarApi.GetUncollectedReward(parsedAddress)
	if err != nil {
	...
	template := rpcClient.PillarApi.CollectReward()
